...
namespace UfcComScraper.ScrapySharp
{
    public class ScrapySharpUfcScraper : IUfcScraper
    {
        ...
        public ScrapySharpUfcScraper()
        {
            _browser = new ScrapingBrowser();
        }

        public ScrapySharpUfcScraper(ScrapingBrowser browser)
        {
            _browser = browser;
        }
